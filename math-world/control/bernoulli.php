...
?>
	<div class="container" id="<?php echo basename(__FILE__, '.php')?>">
		...
		<div>
    		<table><thead>
    			<tr><td>回数</td><td>確率</td></tr>
    		</thead><tbody>
    			<tr><td>0</td><td>`(1/2)^4 = 1/16`</td></tr>
    			<tr><td>1</td><td>`4 * 1/2 * (1/2)^3 = 4/16`</td></tr>
    			<tr><td>2</td><td>`6/16`</td></tr>
    			<tr><td>3</td><td>`4 * (1/2)^3 * 1/2 = 4/16`</td></tr>
    			<tr><td>4</td><td>`(1/2)^4 = 1/16`</td></tr>
    		</tbody></table>
    		...
    		<p>この表が表す回数を確率変数にする確率分布を<b>ベルヌーイ分布</b>という</p>
		</div>
